...
function showDetail(postId) {
    ...
    postContent.innerHTML = `
        ...
        <div class="swet">
            <div class="laptop1">
                <img class="lapto" src="${post.image}" loading="lazy">
            </div>
        </div>
        ` : ''}
    ...
    // Fix: Add video play functionality in post detail
    if (hasVideo) {
        const videoContainer = document.querySelector(".video-container");
        const videoPlayer = videoContainer.querySelector(".video-thumbnail");
