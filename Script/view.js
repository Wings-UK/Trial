    ...
    function showMenu() {
        ...
        if (isOwnPost) {
            bar.innerHTML = `
                ...
                <button class="action-btn delete" data-post-id="${post.id}">Delete</button>
            `;
        } else {
            bar.innerHTML = `
                <button class="action-btn dislike" data-post-id="${post.id}">Dislike</button>
                <button class="action-btn report"  data-post-id="${post.id}">Report</button>
            `;
        }
