...
// Volume Control Code
const volumeIcon = document.querySelector('.volume-control');
const videolayer = document.querySelector('.fullscreen-player');

volumeIcon.addEventListener('click', () => {
    if (videolayer.muted) {
        videolayer.muted = false; // Unmute the video
        ...
        videolayer.muted = true; // Mute the video
        volumeIcon.innerHTML = `
            <svg width="24" height="24" viewBox="0 0 24 24">
...
// Update the volume icon on page load
